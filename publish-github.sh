...
VERSION="v3.2.1"
DESCRIPTION="Experimental DynBQ controller for ASUS GT-BE19000AI on Asuswrt-Merlin: dynamic Broadcom Runner backup queues (64/128/192), per-radio three-band hysteresis, and safe HBQD/offload preservation."
...
if ! git rev-parse "$VERSION" >/dev/null 2>&1; then
  git tag -a "$VERSION" -m "DynBQ V3.2.1 tuned per-radio three-band hysteresis release"
fi
